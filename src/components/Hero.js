...
const Hero = () => {
  return (
    ...
    <section className="  text-gray-600 body-font  -mt-56 sm:p-0 md:pt-16 md:mx-auto " id='hero'>
    <div  className="container mx-auto flex px-0 md:px-5 py-2 md:flex-row flex-col items-center ">
      ...
      <p className="sm:text-2xl md:text-[20px] p-0 mb-8 leading-relaxed  w-2/3    ">{data.hero.desc}</p>
