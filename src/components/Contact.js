...
// form validation for the website
  ...
  <div className="container px-5 py-14 mx-auto flex sm:flex-nowrap flex-wrap">
    ...
    <div className="lg:w-1/3 md:w-1/2  flex flex-col md:ml-auto w-full  md:mt-0">
      <h2 className="text-blue-500  text-2xl mb-1 font-medium title-font">
        Feedback
      </h2>
      ...
      <button onClick={handleSubmit} className="text-white rounded-md outline bg-blue-500 border-0 py-2 px-6  hover:bg-white hover:text-blue-500 text-lg">
        submit
      </button>
    </div>
  </div>
